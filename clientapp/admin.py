...
from .models import (
    ...
    Quote, ActivityLog, Job, JobProduct, JobAttachment
)
...
class QuoteAdmin(admin.ModelAdmin):
    ...
    list_filter = ('status', 'payment_terms', 'include_vat', 'quote_date', 'valid_until')
    ...
    fieldsets = (
        ...
        ('Quote Details', {
            'fields': ('payment_terms', 'status', 'include_vat', 'quote_date', 'valid_until', 'due_date', 'approved_at')
        }),
        ('Additional Information', {
            'fields': ('notes', 'terms', 'loss_reason')
        }),
        ('Tracking', {
